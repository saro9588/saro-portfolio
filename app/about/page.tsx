  ...
  return (
    <div className="mx-auto max-w-screen-lg">
      <div className=" dark:text-white light:text-black">
        <div className="md:grid md:grid-cols-2 sm:grid-cols-1 gap-5 text-default-800 text-container ">
          <div>
            <p>
              ...
              YouTube home page and Tesla and others. Furthermore, my interest
              grew in the field, so I took and successfully completed a few
              online courses on LinkedIn and codecademy.com. After doing some
              research, I decided to enroll in MIT xPro full stack coding
              bootcamp. I was excited to take advantage of the learning
              opportunity from one of the world&apos;s top leading technology
              institutions and its world class faculty. Throughout the bootcamp
              I had weekly assignments and coding challenges to solve and
          ...
          <div>
            <p>
              ...
              perform in 2017. Sharing my passion for music, I&apos;ve been
              deeply involved as both an educator and performer in LA. Teaching
              group and private guitar and music lessons across various schools
              and music academies has been an enriching experience. Throughout
              the past decade, I have been the founder and the manager of my
              private studio with over 40 students. My educational background
              includes a Bachelor of Music and a master&apos;s degree from the
              University of Southern California Thornton School of Music.
              Currently, I am very much looking forward to pivot into the tech
              industry and continue sharing my music on the side.
            </p>
            <Divider />
          </div>
          <div></div>
